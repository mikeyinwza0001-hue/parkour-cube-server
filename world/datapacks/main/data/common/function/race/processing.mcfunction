...
## Race Position
execute unless score @s race_timer matches 1.. as @a[team=race] if score @s raceID = @p raceID run spawnpoint @s 10 -60 -20 0.0 ~
...
#lock position
## Race Position
execute if score @s race_timer matches 2.. as @a[team=race] if score @s raceID = @p raceID run tp @s 10 -60 -20
