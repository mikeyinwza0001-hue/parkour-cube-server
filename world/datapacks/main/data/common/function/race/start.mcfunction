...
#normal
## Race Position
execute if entity @s[tag=race_owner,tag=race_prep] unless entity @a[tag=race_owner,tag=race_on,x=10,y=-60,z=-20,dx=0,dy=0,dz=0] run scoreboard players set @s race_timer 0
execute if entity @s[tag=race_owner,tag=race_prep] unless entity @a[tag=race_owner,tag=race_on,x=10,y=-60,z=-20,dx=0,dy=0,dz=0] run tag @s add race_on
execute if entity @s[tag=race_owner,tag=race_prep] unless entity @a[tag=race_owner,tag=race_on,x=10,y=-60,z=-20,dx=0,dy=0,dz=0] run tag @s remove race_prep